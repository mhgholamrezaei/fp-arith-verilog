#!/bin/bash
# fp16_adder/scripts/run_all.sh - Complete FP16 adder test suite

set -e

echo "INFO: FP16 Adder Complete Test Suite"
echo "===================================="
...
# Build the FP16 adder test
echo "INFO: Building FP16 adder test..."
../apptainer/apptainer_run.sh make all

echo ""
echo "INFO: FP16 adder test suite completed successfully!"
