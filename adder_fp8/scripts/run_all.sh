#!/bin/bash
# fp8_adder/scripts/run_all.sh - Complete FP8 adder test suite

set -e

echo "INFO: FP8 Adder Complete Test Suite"
echo "===================================="
...
# Build the FP8 adder test
echo "INFO: Building FP8 adder test..."
../apptainer/apptainer_run.sh make all

echo ""
echo "INFO: FP8 adder test suite completed successfully!"
