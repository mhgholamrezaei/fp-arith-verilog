#!/bin/bash
# fp16_multiplier/scripts/run_wave.sh - Launch GTKWave for FP16 multiplier VCD files

echo "Launching GTKWave for FP16 Multiplier"
echo "====================================="
...
VCD_FILE="vcd/multiplier_fp16_test.vcd"
if [ ! -f "$VCD_FILE" ]; then
