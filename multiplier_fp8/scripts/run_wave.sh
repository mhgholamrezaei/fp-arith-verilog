#!/bin/bash
# fp8_multiplier/scripts/run_wave.sh - Launch GTKWave for FP8 multiplier VCD files

echo "Launching GTKWave for FP8 Multiplier"
echo "====================================="
...
VCD_FILE="vcd/multiplier_fp8_test.vcd"
if [ ! -f "$VCD_FILE" ]; then
